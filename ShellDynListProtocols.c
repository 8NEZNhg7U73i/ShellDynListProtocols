...
EFIDynCmdProtocolLpHandler(IN EFI_HANDLE *InputHandleBuffer OPTIONAL, IN EFI_GUID **InputProtocolBuffer OPTIONAL, IN UINTN InputHandleCount, IN UINTN InputProtocolCount)
{
    ...
    for (HandleIndex = 0; HandleIndex < HandleCount; HandleIndex++)
    {
        if (InputProtocolBuffer)
        {
            ...
            Print(L"*InputProtocolBuffer0: %g\n", (InputProtocolBuffer)[0]);
            ...
            Print(L"ProtocolBuffer1: %g\n", (ProtocolBuffer)[1]);
            Print(L"ProtocolBuffer2: %g\n", (ProtocolBuffer)[2]);
            Print(L"ProtocolBuffer3: %g\n", (ProtocolBuffer)[3]);
            Print(L"ProtocolBuffer4: %g\n", (ProtocolBuffer)[4]);
            Print(L"ProtocolBuffer5: %g\n", (ProtocolBuffer)[5]);
